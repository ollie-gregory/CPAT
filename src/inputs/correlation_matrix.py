...
class CorrelationMatrix:
    ...
    Accepts either a pandas DataFrame (factor names taken from its columns
    unless factor_names is also given, in which case they must match) or a
    raw ndarray (factor_names is then required). Owns matrix validity: shape,
    symmetry, positive-semi-definite repair, and the Cholesky factor used to
    correlate simulated systematic shocks.
    """
